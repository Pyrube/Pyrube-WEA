 ...
 * @since 2.0
 */
public abstract class WeaSelectedValueComparator {
	 ...
	 */
	public static boolean isSelected(BindStatus bindStatus, String candidateValue) {
		if (bindStatus == null) {
	...
	private static boolean exhaustiveCompare(Object boundValue, Object candidate,
		...
		String candidateDisplayString = candidate.toString();//ValueFormatter.getDisplayString(candidate, editor, false);
