 ...
 * And it is used for the detailed data in a popped dialog
 * 
 * @author Aranjuez
 * @version Dec 01, 2009
 * @since Pyrube-WEA 1.0
 */
public class PopupFormTag extends DetailFormTag {
	/**
	 * serial version uid
	 */
	private static final long serialVersionUID = 3115046943732316978L;
